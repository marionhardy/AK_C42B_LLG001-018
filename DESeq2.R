...
coldata = read_xlsx("./data/C42B-DTR-RNAseq-Code.xlsx", sheet = "Recoded")
...
dds$Combined = relevel(dds$Combined,"Day9_DMSO") 
design(dds) = ~Combined
dds2 = DESeq(dds)
resultsNames(dds2)
...
saveRDS(dds, "./data_output/C42B_DESeq_Day1_vs_DMSO.Rds")
saveRDS(dds1, "./data_output/C42B_DESeq_Day5_vs_DMSO.Rds")
saveRDS(dds2, "./data_output/C42B_DESeq_Day9_vs_DMSO.Rds")
